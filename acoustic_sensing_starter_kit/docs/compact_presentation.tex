...
\textbf{Goal:} How can we maximize the use of acoustic signals for geometrical reconstruction

\vspace{2em}
\textbf{Questions:}
\begin{itemize}
    \item Can we discriminate between different contact conditions using acoustic signals?
...
\begin{itemize}
    ...
    \item Edge detection (contact/edge/no edge) (Batch 3)
    \item Fine feature detection (paper clip present/absent) (Batch 4)
\end{itemize}
\end{frame}

% Slide 3: Dimensionality Reduction Methods
...
% Slide 5: Acoustic Features - Spectral
...
\textbf{Reference:} Standard audio features (Tzanetakis \& Cook, 2002), librosa implementation (McFee et al., 2015)
\end{frame}

% Slide 6: Acoustic Features - MFCC and High-Freq
...
\textbf{Reference:} MFCC theory (Logan, 2000; Davis \& Mermelstein, 1980)
\end{frame}

% Slide 7: Impulse Response Features - Magnitude
...
\textbf{Reference:} Transfer function analysis (Oppenheim \& Schafer, 2010)
\end{frame}

% Slide 8: Impulse Response Features - Decay
...
\textbf{Reference:} Signal processing theory (Oppenheim \& Schafer, 2010)
\end{frame}
...
\textbf{Reference:} Oppenheim \& Schafer (2010) \cite{oppenheim2010discrete}, Zöller et al. (2020) \cite{zoeller2020active}
\end{frame}

% Slide 13: Saliency Analysis - Input and Method
...
% Slide 14: Saliency Analysis - Results and Interpretation
...
\begin{itemize}
    ...
    \item Acoustic features provide crucial complementary information
    \item No single feature type dominates
\end{itemize}
...
\textbf{Main Findings:}
\begin{itemize}
    \item PCA and t-SNE show class separability
    \item Transfer function provides valuable impulse response features
    \item Saliency analysis shows most important features
\end{itemize}
...
McFee, B., Raffel, C., Liang, D., Ellis, D. P., McVicar, M., Battenberg, E., \& Nieto, O. (2015). librosa: Audio and music signal analysis in python. \textit{Proceedings of the 14th Python in Science Conference}, 8, 18-25.

\bibitem{logan2000mel}
Logan, B. (2000). Mel Frequency Cepstral Coefficients for Music Modeling. \textit{International Symposium on Music Information Retrieval}.
...
Rompf, R. A. (2019). \textit{Entwicklung eines akustischen Modells für einen weichen pneumatischen Aktuator}. Master's thesis, Technische Universität Berlin.
