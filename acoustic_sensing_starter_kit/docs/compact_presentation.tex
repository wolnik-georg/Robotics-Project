...
\vspace{0.5em}
\textbf{Most Discriminative Frequency Band:}
\begin{itemize}
    \item 200-2000Hz range provides strongest separation
    \item Mid-frequency acoustic properties are most informative
    \item High frequencies (>8kHz) contribute but are less critical
\end{itemize}
