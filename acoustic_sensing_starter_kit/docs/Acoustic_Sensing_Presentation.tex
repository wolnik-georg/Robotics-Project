...
\begin{itemize}
    ...
    \item \textcolor{successgreen}{\textbf{Multi-band features}} provide discrimination
...
Spectral features and impulse response characteristics provide the critical geometric signatures.
\end{alertblock}
\end{frame}
...
\begin{itemize}
    ...
    \item \textcolor{successgreen}{\textbf{Spectral features}} provide discrimination
...
Q2 & \textcolor{successgreen}{\textbf{Spectral + Impulse}} - Frequency domain + resonance features critical \\
