...
# Measure high frequency shelf filter in JackParameq.
#

# Create and connect objects.
#
F = JackParameq (1, "H", "EQ")
if F.get_state() < 0:
...
for i in range (3):
    ...
    ax.text (500, 21, "freq = 5 kHz, shape = %3.1f" % (s,))
...
ax.text (125, 22, "freq = 5 kHz, gain = +20 dB, shape = 0...1")
