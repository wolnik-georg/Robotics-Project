    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{block}{Why Does This Matter?}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item \textbf{Unexplored modality:} Acoustic sensing is underutilized in robotics
                    \item \textbf{Cheap \& simple:} Just a contact microphone
                    \item \textbf{Rich information:} Sound encodes material, geometry, contact dynamics
                \end{itemize}
            \end{block}
        \end{column}
        ...
        \begin{tikzpicture}
            \node[fill=highlightblue!10, rounded corners, inner sep=6pt, text width=0.9\textwidth] {
                ...
                \begin{itemize}\setlength{\itemsep}{1pt}\setlength{\parskip}{0pt}
                    ...
                    \item[\faCheck] \textbf{Repeatability:} Systematic and reliable sweeps
                    \item[\faCheck] \textbf{Scalability:} Automated collection of datasets
