...
echo ""
echo -e "${GREEN}🛡️  PROTECTION ENABLED: All results will be saved to timestamped directory${NC}"
echo -e "${GREEN}   Output: ${RESULTS_DIR}/${NC}"
echo -e "${GREEN}   Your existing results will NEVER be touched or overwritten!${NC}"
echo ""
